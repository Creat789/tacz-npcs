...
public class ItemRegistry {
    ...
    public static final RegistryObject<SpawnEggItem> DUTYSPAWN = ITEMS.register("duty_spawn_egg", () -> new SpawnEggItem(DutyEntity.DUTY, 0x45372C, 0x9F4748, new Item.Properties()));
    public static final RegistryObject<SpawnEggItem> BANDITSPAWN = ITEMS.register("bandit_spawn_egg", () -> new SpawnEggItem(BanditEntity.BANDIT, 0x3D2B28, 0xD7C5B3, new Item.Properties()));
